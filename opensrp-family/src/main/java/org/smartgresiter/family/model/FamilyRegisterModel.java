package org.smartgresiter.family.model;
...
public class FamilyRegisterModel implements FamilyRegisterContract.Model {
    ...
    public Pair<Client, Event> processRegistration(String jsonString) {
        //TODO return JsonFormUtils.processRegistrationForm(FamilyLibrary.getInstance().context().allSharedPreferences(), jsonString);
        return null;
    }
