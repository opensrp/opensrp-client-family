...
public class BaseFamilyProfileDuePresenterTest extends BaseUnitTest {
    ...
    @Before
    public void setUp() {
        presenter = new BaseFamilyProfileDuePresenter(view, model, viewConfigurationIdentifier, familyBaseEntityId);
    }
    ...
    public void testSetModel() {
        FamilyProfileDueContract.Model newModel = Mockito.mock(FamilyProfileDueContract.Model.class);
