...
public class BaseFamilyOtherMemberProfileFragmentPresenterTest extends BaseUnitTest {
    ...
    @Before
    public void setUp() {
        presenter = new BaseFamilyOtherMemberProfileFragmentPresenter(view, model, viewConfigurationIdentifier, familyBaseEntityId);
    }
    ...
    public void testSetModel() {
        FamilyOtherMemberProfileFragmentContract.Model newModel = Mockito.mock(FamilyOtherMemberProfileFragmentContract.Model.class);
