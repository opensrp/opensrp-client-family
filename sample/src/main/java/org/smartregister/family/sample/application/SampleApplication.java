...
public class SampleApplication extends DrishtiApplication {
    ...
    private FamilyMetadata getMetadata() {
        ...
        metadata.updateFamilyDueRegister(SampleConstants.TABLE_NAME.FAMILY_MEMBER);
        metadata.updateFamilyActivityRegister(SampleConstants.TABLE_NAME.FAMILY_MEMBER);
        return metadata;
    }
